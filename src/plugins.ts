import customResponses from './plugins/custom-responses.ts';
import ligaInfo from './plugins/liga-info.ts';
import messagesLog from './plugins/messages-log.ts';
import nameUpdater from './plugins/name-updater.ts';
import { default as points } from './plugins/points.ts';
